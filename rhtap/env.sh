...
export GITOPS_REPO_URL=https://github.com/rhtap-rhdh-qe/go-rvkuxoyw-gitops
...
export COSIGN_PUBLIC_KEY="LS0tLS1CRUdJTiBQVUJMSUMgS0VZLS0tLS0KTUZrd0V3WUhLb1pJemowQ0FRWUlLb1pJemowREFRY0RRZ0FFQ1RQUkx3bHBVUFo2eXkrdlBQNGk5dHdoSWUvYgpkMWl6UVI1RWoxbXYyVjRGQkhGaElwWXpac2t4dDltNTNuSXJmaytmb04zQVV3a2hROXhYUms0QTFBPT0KLS0tLS1FTkQgUFVCTElDIEtFWS0tLS0tCg=="
...
export REKOR_HOST=${REKOR_HOST-https://rekor-server-tssc-tas.apps.rosa.kx-ef7882cb6c.ksps.p3.openshiftapps.com}
...
export TUF_MIRROR=${TUF_MIRROR-https://tuf-tssc-tas.apps.rosa.kx-ef7882cb6c.ksps.p3.openshiftapps.com}
